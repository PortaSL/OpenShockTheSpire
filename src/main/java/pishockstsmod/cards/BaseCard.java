...
import pishockstsmod.PiShockMod;
import pishockstsmod.util.CardStats;
import pishockstsmod.util.TriFunction;
...
import static pishockstsmod.util.GeneralUtils.removePrefix;
import static pishockstsmod.util.TextureLoader.getCardTextureString;


public abstract class BaseCard extends CustomCard {
    final private static Map<String, DynamicVariable> customVars = new HashMap<>();

    protected static String makeID(String name) { return PiShockMod.makeID(name); }
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    PiShockMod.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
